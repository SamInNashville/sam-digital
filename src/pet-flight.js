...
export function planPetFlight(from,to,{width,height,trip=0,quiet=false}={}){
 ...
 if(distance<12)return addFlightDepth({kind:'settle',points:[{...start,offset:0},{...end,offset:1}],duration:600},{width,height,trip,distance:0,quiet});
 ...
 return addFlightDepth({kind:'parabola',points,duration:Math.min(4200,2300+distance*1.5)},{width,height,trip,distance,quiet});
}
