...
try{
 await page.goto(base);await expect(page.locator('#intro')).toHaveCount(0);await expect(page.locator('#showcase canvas')).toBeVisible();await expect(page.getByText('Meet Sam. AI, not a human.',{exact:true})).toBeVisible();await expect(page.locator('#companion')).toBeVisible();
