...
try{
 await page.goto(base);await expect(page.locator('#intro')).toHaveCount(0);await expect(page.locator('#showcase [data-demo]')).toHaveCount(4);await expect(page.locator('#showcase canvas')).toHaveCount(0);await expect(page.getByRole('heading',{name:'Sam is here to help you.',exact:true})).toBeVisible();await expect(page.locator('#companion')).toBeVisible();
