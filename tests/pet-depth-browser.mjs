...
try{
 ...
 await p.locator('.breakout-start').focus();await expect(p.locator('.dot-flight')).toHaveAttribute('data-target-kind','breakout',{timeout:8000});await expect(p.locator('.dot-flight')).toHaveAttribute('data-flying','false',{timeout:8000});
