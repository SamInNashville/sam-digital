...
try{
 ...
 for(const message of ["I'd like to make a mobile game where many people can play dominos",'I want it on both iPhone and Android.','This is a new project.']){
 ...
 // No prescribed question sequence: verify genuine responses and preserved conversation.
 for(const r of results){expect(r.answer.length).toBeGreaterThan(20);expect(r.answer).not.toContain('not sure I can');}
